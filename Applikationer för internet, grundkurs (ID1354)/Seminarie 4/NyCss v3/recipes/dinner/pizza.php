...
<head>
	...
	<div id="container">
	 ...
	 <div id="login">   
		   ...
		   if($user->isloggedIn())
			   include URL . "/data/View/logoutButton.php";
 
		   else{
			   include URL . "/data/View/loginButton.php";
                            include URL . "/data/View/registerButton.php";
                   }
...
<nav>
 ...
 <img src="/Images/Dinner/pizza.jpg" alt="Pizza"/>
	...
	<div id="box">
            ...
            include URL . '/data/commentFunction.php';
