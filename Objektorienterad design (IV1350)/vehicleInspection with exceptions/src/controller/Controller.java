...
public int cashLeftInRegister = new CashRegister().totalAmountCash + cashToPay;
	 ...
	 */
	public void controller() throws WrongLicenseNumberException
	{
		new View().view();
	}
 ...
 * @throws WrongLicenseNumberException 
 */
	public boolean enterVehicleInfo(String licensenumber) throws WrongLicenseNumberException
	{
	new	DbHandler().giveLicenseNumber(licensenumber);
		return true;
